...
class TimeAvailabilityScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<TimeAvailabilityScreen> createState() =>
      _TimeAvailabilityScreenState();
}

class _TimeAvailabilityScreenState
    extends ConsumerState<TimeAvailabilityScreen> {
  static const Color _selectedFill = Color(0xFFEEEDFD);
  static const int _analyzeStep = 5;
  static const int _analyzeTotalSteps = 5;

  String _selected = 'Very Limited';
  ...
  void _continue() {
    ref.read(draftDecisionProvider.notifier).update(
          (d) => d..timeAvailability = _selected,
        );
    context.push(AppRoutes.aiQuestionFlow);
  }
