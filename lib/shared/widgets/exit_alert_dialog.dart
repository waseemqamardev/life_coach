...
Future<bool> showExitAlertDialog(BuildContext context) async {
  final bool? confirmed = await showDialog<bool>(
    ...
    builder: (BuildContext context) => const _ExitAlertDialog(),
  );

  return confirmed ?? false;
}

class _ExitAlertDialog extends StatelessWidget {
  const _ExitAlertDialog();
...
class _ExitConfirmButton extends StatelessWidget {
  const _ExitConfirmButton({
    required this.label,
...
class _ExitCancelButton extends StatelessWidget {
  const _ExitCancelButton({
    required this.label,
    required this.onPressed,
  });
